...
class ArtifactStatus(str, Enum):
    ...
    ACTIVE = "active"
    COMPLETED = "completed"
    FAILED_BUT_INFORMATIVE = "failed_but_informative"  # Crucial for psychological safety
...
class BaseArtifact(SQLModel, table=True):
    ...
    grace_period_end: Optional[datetime] = None # If set, protected from Mesh/Sync until this date
